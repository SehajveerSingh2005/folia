...
export const availableWidgets = [
  ...
  { type: 'Clock', name: 'Clock', icon: Clock, description: 'A simple, elegant digital clock.', w: 4, h: 2, minW: 3, minH: 2, mw: 2, mh: 2, preview: <ClockPreview /> },
  { type: 'DueToday', name: 'Due Today', icon: CalendarCheck, description: 'See all tasks that are due today.', w: 6, h: 4, minW: 4, minH: 3, mw: 2, mh: 4, preview: <DueTodayPreview /> },
  { type: 'Inbox', name: 'Task Inbox', icon: Inbox, description: 'Quickly add and manage your inbox tasks.', w: 6, h: 4, minW: 4, minH: 4, mw: 2, mh: 4, preview: <InboxPreview /> },
  { type: 'Notes', name: 'Quick Note', icon: StickyNote, description: 'Jot down a quick thought for your Garden.', w: 6, h: 4, minW: 4, minH: 3, mw: 4, mh: 4, preview: <NotesPreview /> },
  { type: 'Journal', name: 'Journal', icon: BookOpen, description: 'A prompt for your daily journal entry.', w: 6, h: 3, minW: 4, minH: 3, mw: 4, mh: 3, preview: <JournalPreview /> },
  { type: 'Goals', name: 'Goals Overview', icon: Telescope, description: 'A glimpse of your long-term Horizon goals.', w: 6, h: 3, minW: 4, minH: 3, mw: 4, mh: 3, preview: <GoalsPreview /> },
  { type: 'Flow', name: 'Active Projects', icon: FolderKanban, description: 'Track the progress of your active projects.', w: 6, h: 3, minW: 4, minH: 3, mw: 4, mh: 3, preview: <FlowPreview /> },
];
