...
export const availableWidgets = [
  { type: 'Welcome', name: 'Welcome Greeting', icon: Smile, description: 'A personalized greeting for your day.', w: 4, h: 4, minW: 4, minH: 4, mw: 4, mh: 4, preview: <WelcomePreview /> },
  ...
  { type: 'Journal', name: 'Journal', icon: BookOpen, description: 'A prompt for your daily journal entry.', w: 6, h: 4, minW: 4, minH: 4, mw: 4, mh: 4, preview: <JournalPreview /> },
  { type: 'Goals', name: 'Goals Overview', icon: Telescope, description: 'A glimpse of your long-term Horizon goals.', w: 6, h: 4, minW: 4, minH: 4, mw: 4, mh: 4, preview: <GoalsPreview /> },
  { type: 'Flow', name: 'Active Projects', icon: FolderKanban, description: 'Track the progress of your active projects.', w: 6, h: 4, minW: 4, minH: 4, mw: 4, mh: 4, preview: <FlowPreview /> },
];
