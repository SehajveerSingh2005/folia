...
export const availableWidgets = [
  ...
  { type: 'Inbox', name: 'Task Inbox', icon: Inbox, description: 'Quickly add and manage your inbox tasks.', w: 3, h: 5, minW: 3, minH: 4, mw: 3, mh: 5, preview: <InboxPreview /> },
  { type: 'Notes', name: 'Quick Note', icon: StickyNote, description: 'Jot down a quick thought for your Garden.', w: 3, h: 4, minW: 3, minH: 3, mw: 3, mh: 4, preview: <NotesPreview /> },
  { type: 'Journal', name: 'Journal', icon: BookOpen, description: 'A prompt for your daily journal entry.', w: 3, h: 4, minW: 3, minH: 4, mw: 3, mh: 4, preview: <JournalPreview /> },
  { type: 'Goals', name: 'Goals Overview', icon: Telescope, description: 'A glimpse of your long-term Horizon goals.', w: 3, h: 4, minW: 3, minH: 4, mw: 3, mh: 4, preview: <GoalsPreview /> },
  { type: 'Flow', name: 'Active Projects', icon: FolderKanban, description: 'Track the progress of your active projects.', w: 3, h: 4, minW: 3, minH: 4, mw: 3, mh: 4, preview: <FlowPreview /> },
];
