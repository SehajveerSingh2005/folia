...
export const availableWidgets = [
  ...
  { type: 'GitHubHeatmap', name: 'GitHub Heatmap', icon: Github, description: 'View your real GitHub contribution heatmap and streak.', w: 6, h: 4, minW: 5, minH: 4, mw: 8, mh: 4, preview: <div className="p-4 flex flex-col items-center justify-center h-full text-center"><Github className="h-8 w-8 opacity-20 mb-1" /><p className="text-[10px] text-muted-foreground">Contribution Heatmap</p></div> },
