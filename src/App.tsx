...
const APP_VERSION = "1.2.0"; // Increment this version to trigger a settings reset for all users
...
const App = () => {
  useEffect(() => {
    ...
    if (storedVersion !== APP_VERSION) {
      ...
      localStorage.removeItem('horizonViewMode'); // Clear old horizon view mode
